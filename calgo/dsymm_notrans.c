...
void dvpur_symm_ua_notrans(mdata_t *C, const mdata_t *A, const mdata_t *B, double alpha,
			   double beta, int nP, int S, int L, int R, int E, int vlen)
{
...
// are odd.
void dmult_symm_ua_notrans(mdata_t *C, const mdata_t *A, const mdata_t *B,
